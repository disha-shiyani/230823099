...
//         { id: 6, title: 'Song 6', artist: 'Artist 6', duration: '2:50', image: image3, mp3: song1 }
//     ];
...
//                 <h1 className="text-center mb-2" style={{ color: "white" }}>Music List</h1>
//                 {musicList.map((music) => (
//                     <Row key={music.id} className="mb-3">
//                         <Col md={12}>
//                             <Card className="d-flex flex-row align-items-center">
//                                 <img src={music.image} alt={music.title} style={{ width: '80px', height: '80px', objectFit: 'cover', marginLeft: "20px", padding: "10px", borderRadius: "50%" }} />
//                                 <div className="ml-3" style={{ marginLeft: "20px" }}>
...
const MusicListPage = () => {
    ...
    const musicList = [
        ...
        { id: 4, title: 'Song 4', artist: 'Artist 4', duration: '3:45', image: image4, mp3: song4 },
        { id: 5, title: 'Song 5', artist: 'Artist 5', duration: '4:20', image: image5, mp3: song5},
        { id: 6, title: 'Song 6', artist: 'Artist 6', duration: '2:50', image: image1, mp3: song1 },
        { id: 7, title: 'Song 7', artist: 'Artist 7', duration: '3:45', image: image2, mp3: song4 },
        { id: 8, title: 'Song 8', artist: 'Artist 8', duration: '4:20', image: image3, mp3: song5},
        { id: 9, title: 'Song 9', artist: 'Artist 9', duration: '2:50', image: image4, mp3: song1 },
        { id: 10, title: 'Song 10', artist: 'Artist 10', duration: '4:20', image: image5, mp3: song5},
        { id: 11, title: 'Song 11', artist: 'Artist 11', duration: '2:50', image: image1, mp3: song1 },
        { id: 12, title: 'Song 12', artist: 'Artist 12', duration: '2:50', image: image2, mp3: song1 }
    ];
        ...
        <div className="mt-2">
            ...
            <div className="gradient-background p-4" style={{ minHeight: '100vh' }}>
                ...
                <Row>
                    {/* First Column */}
                    <Col md={6}>
                        {musicList.slice(0, Math.ceil(musicList.length / 2)).map((music) => (
                            <Card key={music.id} className="d-flex flex-row align-items-center mb-3">
                                <img src={music.image} alt={music.title} style={{ width: '80px', height: '80px', objectFit: 'cover', marginLeft: "20px", padding: "10px", borderRadius: "50%" }} />
                                <div className="ml-3" style={{ marginLeft: "20px" }}>
                                    <h5>{music.title}</h5>
                                    <p className="mb-0">{music.artist}</p>
                    ...
                    {/* Second Column */}
                    <Col md={6}>
                        {musicList.slice(Math.ceil(musicList.length / 2)).map((music) => (
                            <Card key={music.id} className="d-flex flex-row align-items-center mb-3">
                                <img src={music.image} alt={music.title} style={{ width: '80px', height: '80px', objectFit: 'cover', marginLeft: "20px", padding: "10px", borderRadius: "50%" }} />
                                <div className="ml-3" style={{ marginLeft: "20px" }}>
                                    <h5>{music.title}</h5>
